//NOTE: copied from: https://stackoverflow.com/questions/5046088/affinetransform-without-transforming-stroke
    ...
    implements Stroke
{
    ...
    public void set(Stroke base, AffineTransform at) throws NoninvertibleTransformException {
