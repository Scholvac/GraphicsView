...
public class Example {
	...
	private static Shape wkt2Shape(String wkt) {
	...
	public static void main(String[] args) {
		...
		GraphicsItem item = new GraphicsItem(wkt2Shape("POLYGON ((-100 -100, 100 -100, 100 100, 0 200, -100 100, -100 -100))"));
		scene.addItem(item);
		...
		for (String wkt : sideWkts) {
			GraphicsItem subItem = new GraphicsItem(wkt2Shape(wkt));
