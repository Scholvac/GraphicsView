...
public class OfflineRenderingExample extends JFrame {
	...
	public static void main(final String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					final OfflineRenderingExample frame = new OfflineRenderingExample("Offline Rendering");
	 ...
	 * Create the frame.
	 */
	public OfflineRenderingExample(final String title) {
		super(title);
