...
public class InteractiveIndexExample {
	...
	static class MyBIGNodeFactory implements IBIGNodeFactory<DefaultEntry<GraphicsItem>>{
		@Override
		public IBIGNode<DefaultEntry<GraphicsItem>> createNode(final Rectangle2D geometry, final IBIGNode<DefaultEntry<GraphicsItem>> parent) { return new MyBigNode(geometry, parent); }
		@Override
		public IBIGNode<DefaultEntry<GraphicsItem>> createLeaf(final Rectangle2D geometry, final IBIGNode<DefaultEntry<GraphicsItem>> parent) { return new MyBigLeaf(geometry, parent); }
