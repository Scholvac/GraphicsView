...
public class MoveScaleRotateItemExample {
	...
	public static void main(final String[] args) {
		...
		final JFrame frame = new JFrame("Move - Scale - Rotate - Example");
