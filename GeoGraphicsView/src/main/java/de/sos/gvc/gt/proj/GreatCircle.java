...
public class GreatCircle {
	...
	protected static transient int NUM_DEFAULT_GREAT_SEGS = 512; //based of openmap:NUM_DEFAULT_GREAT_SEGS = 512;
    ...
    public static LatLonPoint pointAtDistanceBetweenPoints(double phi1, double lambda0, double phi,
        ...
        if (pntDist > distance) {
            ...
            int index = (int) (gcpoints.length / 2 * distRatio) * 2;
    ...
    final public static float[] earthCircle(float phi1, float lambda0, float c, int n) {
        return earthCircle(phi1, lambda0, c, 0.0f, ProjMath.TWO_PI_F, n, new float[n << 1]);
    }
    ...
    final public static float[] earthCircle(float phi1, float lambda0, float c, int n,
                                            float[] ret_val) {
        return earthCircle(phi1, lambda0, c, 0.0f, ProjMath.TWO_PI_F, n, ret_val);
    }
    ...
    final public static double[] earthCircle(double phi1, double lambda0, double c, int n) {
        return earthCircle(phi1, lambda0, c, 0.0f, ProjMath.TWO_PI_D, n, new double[n << 1]);
    }
    ...
    final public static double[] earthCircle(double phi1, double lambda0, double c, int n,
                                             double[] ret_val) {
        return earthCircle(phi1, lambda0, c, 0.0f, ProjMath.TWO_PI_D, n, ret_val);
    }
