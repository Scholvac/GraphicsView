...
public abstract class LatLonPoint extends Point2D implements Cloneable, Serializable {
    ...
    public static class Float extends LatLonPoint {
		...
		public void setLatLon(double lat, double lon, boolean isRadians) {
            if (isRadians) {
                ...
                this.lat = (float) LatLonPoint.normalizeLatitude(lat);
                this.lon = (float) LatLonPoint.wrapLongitude(lon);
	...
	public boolean equals(Object obj) {
        ...
        return (ProjMath.approximately_equal(getY(), pt.getY()) && ProjMath.approximately_equal(getX(), pt.getX()));
    }
