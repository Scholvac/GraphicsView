...
public class RotateViewExample {
	...
	public static void main(String[] args) throws IOException {
		...
		MultiCacheFactory<OSMTileDescription> factory = new MultiCacheFactory<>(new OSMTileFactory(), new OSMTileDownloader(), new File(System.getProperty("user.home") + "/.OSMCache"),  100 * 1024 * 1024,  20 * 1024 * 1024,  20 * 1024 * 1024);
